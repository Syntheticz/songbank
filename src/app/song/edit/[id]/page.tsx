      ...
      <div className="w-full flex flex-col gap-4">
        ...
        <div className="w-full py-4 px-6">
          ...
          <button
            ...
            className=" ml-4 hover:text-primary hover:bg-white hover:border-primary hover:border-2 p-2 px-3 transition-all bg-primary border-2 text-sm border-tertiary font-montserrat font-semibold rounded-md text-white drop-shadow-md active:bg-primary active:text-white"
          >
            Delete
          </button>
        </div>
